  ...
  const recentActivity = [
    {
      id: "1",
      type: "booking",
      message: "Đặt lịch thành công tại Studio Ánh Dương",
      time: "2 giờ trước",
      icon: Calendar,
    },
    {
      id: "2",
      type: "favorite",
      message: "Đã thêm Makeup Artist Mai vào yêu thích",
      time: "1 ngày trước",
      icon: Heart,
    },
    {
      id: "3",
      type: "review",
      message: "Đã đánh giá 5 sao cho Studio Minh Châu",
      time: "3 ngày trước",
      icon: Star,
    },
  ]
                          ...
                          <div className="flex-1">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Button size="sm" variant="outline" asChild>
                                <Link href={`/${item.type}/${item.id}`}>Xem chi tiết</Link>
                              </Button>
                            </div>
                          </div>
                        </div>
