...
export default function RentalDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const data = {
    ...
    categories: [
      {
        ...
        description: "Áo cưới cao cấp từ các thương hiệu nổi tiếng",
        popular: true,
      },
      {
        id: "2",
        ...
        description: "Vest nam lịch lãm cho chú rể",
        popular: true,
      },
      {
        id: "3",
    ...
    bookedSlots: [
      {
        ...
        services: ["Thử áo cưới", "Tư vấn phong cách"],
        status: "confirmed",
      },
      {
        date: "2024-01-26",
        timeSlots: ["10:00-14:00"],
        services: ["Thử vest nam"],
        status: "confirmed",
      },
    ],
    ...
    policies: {
      rental: [
        "Đặt cọc 30% giá trị trang phục",
        "Thời gian thuê tối thiểu 3 ngày",
        "Miễn phí thử đồ trước khi thuê",
        "Giao nhận tận nơi trong bán kính 10km",
      ],
      return: [
        "Trả đồ đúng hạn để tránh phí phạt",
        "Kiểm tra tình trạng trang phục khi trả",
        "Phí giặt ủi đã bao gồm trong giá thuê",
        "Bồi thường theo quy định nếu hư hỏng",
      ],
      cancellation: [
        "Hủy trước 7 ngày: Hoàn 100% tiền cọc",
        "Hủy trước 3 ngày: Hoàn 50% tiền cọc",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-96 w-full">
        <Image src={rentalData.coverImage || "/placeholder.svg"} alt={rentalData.name} fill className="object-cover" />
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex gap-3">
                    <Button asChild>
                      <Link href={`/booking?rental=${rentalData.id}`}>
                    ...
                    <CardContent className="p-6">
                      <div className="flex justify-between items-start mb-4">
                        ...
                        <div className="text-right">
                          ...
                          <Button asChild>
                            <Link href={`/booking?rental=${rentalData.id}&category=${category.id}`}>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href={rentalData.website} className="text-purple-600 hover:underline">
                    Website
                  </a>
                </div>
